...
TOKEN=$(curl -s --request POST \
  ...
  --data '{"client_id":"<mgmt-client-id>","client_secret":"<mgmt-secret>","audience":"https://<AUTH0_DOMAIN>/api/v2/","grant_type":"client_credentials"}' \
  | jq -r '.access_token')

# Assign role to user
curl --request POST \
  --url "https://<AUTH0_DOMAIN>/api/v2/users/<user-id>/roles" \
...
- Tenant: https://manage.auth0.com/dashboard/us/<YOUR_TENANT>
- Users: https://manage.auth0.com/dashboard/us/<YOUR_TENANT>/users
- Roles: https://manage.auth0.com/dashboard/us/<YOUR_TENANT>/roles
